<div>
    <div class="row match-height">
        ...
        <div class="col-xl-4 col-md-6 col-12">
            <div class="card card-congratulation-medal">
                <div class="card-body">
                    <h5>Congratulations 🎉 {{$provider -> name}}!</h5>
                    <h3 class="mb-75 mt-2 pt-50">
                        <a href="javascript:void(0);">4.9k</a>
                    </h3>
                    <button type="button" class="btn btn-primary waves-effect waves-float waves-light">Monthly  Visits</button>
                </div>
            </div>
        </div>
        <!--/ Medal Card -->
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    ...
                                    <p class="card-text font-small-3 mb-0">Vists</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                        ...
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    <h4 class="font-weight-bolder mb-0">700</h4>
    ...
    <livewire:merchant.services-component :merchant="$provider->id"/>
</div>
