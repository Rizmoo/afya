                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="email" name="email"  type="text" class="form-control rounded" placeholder="Email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="name" name="name"  type="text" class="form-control rounded" placeholder="User">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="county" name="county" type="text" class="form-control" placeholder="City">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="bio" name="bio" class="form-control rounded" placeholder="Bio"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input  wire:model="address" name="address" type="text" class="form-control" placeholder="#10 Marke Juger, SBI Road">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="website" name="website" type="text" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="phone" name="phone_number" type="text" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="fb" name="fb" type="text" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input wire:model="company_email" name="company_email" type="email" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <label class="text-dark ft-medium">Name</label>
                                            <input wire:model="company_name" name="company_name" type="text" class="form-control" placeholder="">
                                        </div>
                                    </div>
