                                        ...
                                        <div class="cats-box-caption pl-3">
                                            <div class="jb-list01">
                                                <div class="jb-list-01-title"><h5 class="ft-medium mb-1">
                                                        <a href="{{ route('shop.provider', $provider ) }}">{{ $provider -> name }}</a>
                                                    </h5>
                                                </div>
                                                <div class="jb-list-01-info d-block mb-2">
                                                    <span class="text-muted mr-2"><i class="lni lni-map-marker mr-1"></i>{{ $provider ->  address }}</span>
                                                    <span class="text-muted mr-2"><i class="lni lni-briefcase mr-1"></i>{{ $provider -> email }}</span>
                                                    <span class="text-muted mr-2"><i class="lni lni-star-filled mr-1"></i>{{ $provider  -> phone }}</span>
