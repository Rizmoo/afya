<div>
    <section class="doctor-details-area ptb-100">
                ...
                <div class="col-lg-7 col-md-12">
                    <div class="doctor-details-desc">
                        ...
                        <div class="signature-image">
                            <img src="{{ asset('fovia') }}/assets/img/signature.png" alt="image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="shape3"><img src="{{ asset('fovia') }}/assets/img/shape/3.png" class="wow fadeInLeft" alt="image" style="visibility: visible; animation-name: fadeInLeft;"></div>
    </section>
</div>
